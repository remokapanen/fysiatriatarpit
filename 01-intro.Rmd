...
## Luento 3: Alaraajasairaudet

Tässä alla tämän diapaketin aiheisiin liittyvät kysymykset

### Mikä kuvantamistutkimus trokanterbursiitissa?
...
Trocanther majorin kipuoireyhtymän taustalla voi olla ison sarvennoisen alueelle kiinnittyvien pakaralihasten (m. gluteus medius ja maximus) insertiokohdan tulehdusreaktio, jänteen rappeumamuutokset tai ison sarvennoisen limapussitulehdus (bursiitti).
...
On tärkeää korostaa potilaalle tilan vaarattomuutta, vaikka kipu voikin kestää kuukausia.
Lääkehoitona käytetään tulehduskipulääkettä ja parasetamolia tarvittaessa. Pitkittyvää kiputilaa voidaan hoitaa myös pakaralihaksen kiinnityskohtaan ruiskutettavalla puudute-glukokortikoidi-injektiolla. 
...
![](images/trokanterbursiitti.png)
  </div>
</div>

### Mikä liikelaajuus rajoittuu herkimmin lonkan nivelrikossa?
...
Lonkkanivelestä tutkitaan passiivinen abduktio ja adduktio, sisään- ja uloskierto, koukistus ja ojennus. Sisäänkierto rajoittuu herkimmin, mutta myös muut liikelaajuudet voivat pienentyä ja lonkan lihasvoima (loitonnus-, lähennys- ja koukistusvoima) voi heikentyä. Passiivisen liikuttamisen yhteydessä voi tuntua kipua tai ritinää.
...
![](images/lonkanliikelaajuudet.png)
  </div>
</div>

## Luento 4: Niskakipu ja yläraajan sairaudet {#Niskakipu-ja-ylaraajan-sairaudet}

### Whiplash-vamman hoidon periaatteet
...
### Epikondyliitin hoito

Valitse yksi 

- a. Jatkuvat glukokortikoidi-injektiot
- b. Kuukauden lepo
- c. Lepo (suhteellinen), fysioterapia, kylmä, tuki
- d. joku 
...
![](images/tenniskyynärpäätuki.png)
![](images/epikondyliitti.png)
  </div>
</div>

## Luento 6: Laaja-alaiset kivut, CPRS, toimintakykyarvio

### Milloin voidaan harkita vahvoja opioideja 

Valitse yksi

- a. Kivun syy on tiedetty, muut hoitomenetelmät on kokeiltu, ei ole aiempaa päihdeongelmaa, ei ole hoitamatonta psykiatrista ongelmaa, potilas on yhteistyökykyinen, motivoitunut hoitokokeiluun ja sitoutuu hoitosopimukseen, jatkohoito on turvattu
- b. Kivun syy on tuntematon, voimakas kipu yli kolme kuukautta, tulehduskipulääkkeiden ja mietojen opioidien tehottomuus
- c.  Kipu on kestänyt 6kk ja on hyvin laaja-alainen
- d. Kipu aiheuttaa ahdistuneisuutta
...
Valitun kipulääkkeen vaikutusmekanismin tulee olla tarkoituksenmukainen, lääkkeen tehosta tulee olla näyttöä ja lääkkeen tulee olla hyvin siedetty. 
  </div>
</div>


### Fibromyalgian ensisijainen lääkehoito 
...
HUOM! Lääkkeetön hoito on tärkeintä. Tähän kuuluu tärkeimpinä säännöllinen liikunta, hyvä unihygienia ja potilaan opettaminen oireyhtymän luonteesta. Koska jumppien ja liikunnan aloittamiseen liittyy lihaskipujen lisääntymistä, liikunta kannattaa aloittaa varovasti ja vähitellen elimistöä kuunnellen ("start low, go slow") ja siihen kannattaa liittää myös venyttelytyyppisiä ja rentouttavia elementtejä. Suuri osa potilaista ei tarvitse itsehoidon lisäksi muuta hoitoa, jos fibromyalgiadiagnoosi on tehty riittävän varhain eikä sairauteen liittyvä lisäongelmia ja pysyviä patofysiologisia muutoksia ole kehittynyt.
  </div>
</div>
...
### CRPS:n hoitoperiaate

- a. Nopeasti invalidisoiva tila, joka yleensä vaatii kiireellisen lähetteen kipuklinikalle tai fysiatrian poliklinikalle moniammatillista arviota ja hoitoa varten
- b. Parantuu itsestään 1-3 kuukaudessa
- c. Ei-hermoperäinen CRPS liittyy somatisaatiohäiriöön ja tulee tehdä lähete psykiatrille, jos oireet eivät helpota 3kk sisällä
- d. Pistetään kortisonipistokset kipeisiin paikkoihin ja vain tarpeen mukaan oraalisia kipulääkkeitä
...
Käyty juuri yllä läpi. 
  </div>
</div>

### Mitkä ovat CRPS:ssä ilmenevät tuntomuutokset

- a. värinätunto
- b. syvätunto
- c. hyperalgesia ja allodynia
- d. hypoalgesia
...
Hyperalgesia tarkoittaa tilaa, jossa stimulus, joka yleensäkin aiheuttaa kipua, aiheuttaa nyt vielä suurempaa kipua. Eroaa allodyniasta  = aikaisemmin kivuton stimulus aiheuttaa nyt kipua (esim. suihku auringossa palamisen jälkeen)

Muut vaihtoehdot kuvailevat hypoestesiaa eli tunnon heikentymistä, joka ei ole CRPS:lle tyypillinen piirre. 
  </div>
</div>

### Määrittele toimintakyky
...
![](images/toimintakyvynmittaustaulukko.png)
![](images/toimintakyvynmittaus.png)
...
![](images/suoritustaso.png)

### Mitä tarkoittaa suorituskyky

- a. Potilaan maksimaalinen suoriutuminen tietyissä tehtävissä täydellisissä olosuhteissa
- b. Potilaan suoriutuminen ilman apuvälineitä
- c. Valmiutta suorittaa päivittäisiä toimintoja
...
Käyty jo monta kertaa yllä läpi.
  </div>
</div>
...
- Ilman työterveyslääkärin asiantuntemusta työkyvyn rajoitteiden kuvaus on 
...
- a. työkyky osa toimintakykyä
- b. Katsovat samaa asiaa eri näkökulmasta
- c. Toimintakyky osa työkykyä
...
### Aiheuttaako sama sairaus samaa toimintakyvyn alenemaa

Valitse yksi

- a. Sama sairauden vaikeusaste aiheuttaa aina saman aleneman toimintakyvyssä eri ihmisillä
- b. Sama sairaus voi aiheuttaa erilaisen aleneman toimintakyvyssä eri ihmisillä
- c. Sama sairaus aiheuttaa aina saman aleneman toimintakyvyssä eri ihmisillä
- d. Erilaisen toimintakyvyn alenemisen muodostumiseen vaaditaan aina eri sairaus
...
![](images/samasairaus.png) 
  </div>
</div>

### Mikä lausunto tarvitaan vammaistukihakemusta varten?
...
![](images/lausunnotlyhyesti.png)
  </div>
</div>

## Luento 7 : Alaselkäkipu
...
Kivun kesto, kipulääkkeiden riittämättömyys, rappeumamuutokset 
radiologisissa tutkimuksissa, potilaan turhautuneisuus, sairausloman 
pitkittyminen EIVÄT ole punaisia lippuja!
  
![](images/punaisetliputkäypähoito.png)
![](images/punaisetliputdiat.png)

### Mitä laboratoriokokeita otetaan alaselkäkipupotilaalta? {#Alaselkakipupotilas-labrat}

- a. TVK, CRP, ALAT
- b. Ei mitään
- c. Reumafaktori, tumavasta-aineet, munuaisarvot
- d. Joku muu
...
Laboratoriotutkimukset yleensä eivät ole tarpeen. Jos epäilet punaisen lipun oireita, lähetä eteenpäin. 

Myöskään kuvantamistutkimukset eivät yleensä ole tarpeen. 
  </div>
</div>

### Epäspesifin alaselkäkivun lääkehoito 
...
![](images/lääkehoitokrooninenalaselkäkipu.png)
...
![](images/fasettinivelet.png)
![](images/fasettinivelrtg.png)
![](images/radiologisetlöydökset.png)

### Miten tulee suhtautua Scheuermannin taudin löydöksiin röntgenissä?

Valitse yksi 

- a. Vaatii usein lisäselvityksiä
- b. Selittää potilaan selkäkipua
- c. On usein vain esteettinen haitta
- d. Joku (Ei tärpeissä)
...
Kasvukauden loppuvaiheessa ilmaantuvaa idiopaattista rakenteellista kyfoosia kutsutaan Scheuermannin taudiksi. Scheuermannin tauti on siis nikamien kasvuhäiriö (nuoruusiän selkärangan osteokondroosi). Sitä tulisi seuloa 7.–8. luokan terveystarkastuksissa. Tautia ei juuri esiinny alle 10-vuotiailla. Aikuisilla kyse on pikemminkin taudin jälkitilasta.
...
![](images/scheuermann.png)
![](images/scheuermannaikuinen.png)
  </div>
</div>

### Spinaali ja verisuoniperäisen katkokävelyn ero
...
![](images/klaudikaatio.png)
![](images/katkokävely.png)
![](images/katkokävelyyhteenveto.png)

### Milloin ENMG iskiaskipuiselle?

- a. Heti oireiden alkamisen jälkeen
- b. Vuosi oireiden alkamisen jälkeen
- c. ENMG:llä ei ole roolia iskiaskivun tutkimisessa
- d. 1-2kk kivun alkamisen jälkeen
...
### Välilevyrappeuman seurantaperiaate

- a. Normaalilöydös iän myötä, ei vaadi seurantaa
- b. Magneetti vuoden välein
- c. Pitää tehdä lähete ESH leikkausarvioon
- d. Suosittele, että potilas vaihtaisi rennompaan työhön
...
### Kumpi spondylolisteesin muodoista aiheuttaa herkemmin selkäydinkanavan ahtauman?


- a. Spondylolyyttinen
- b. Degeneratiivinen
- c. Ei kumpikaan
- d. Molemmat yhtä paljon
...
Degeneratiivinen nikamansiirtymä (spondylolisteesi) on yleinen radiologinen löydös, joka liittyy ikääntymiseen. Johtuu fasettinivelien ja välilevyjen rappeutumisesta, joka johtaa koko nikaman siirtymiseen eteenpäin. Tämä voi ahtauttaa selkäydinkanavaa. 
...
### Kuntoutuksen sijainti hoitoketjussa

Valitse yksi 

- a. Kuntoutuksella lievitetään oireita
- b. Kuntoutuksella estetään uusiutumista
- c. Kuntoutuksella varmistetaan henkilön osallistumista hänelle tavanomaisiin toimiin sairauden aiheuttaman vaikeudesta huolimatta
- d. Kuntoutuksella pyritään palauttamaan henkilön toimintakyky korkeimmalle mahdolliselle tasolle
...
![](images/kuntoutuksensijainti.png)
  </div>
</div>

### Kuntoutuksen peruste

- a. Toimintakyvyn aleneminen
- b. Oireiden vaikeusaste
- c. Hidas paraneminen
- d. Pitkittynyt sairasloma
...
### Missä lääkkeellistä kuntoutusta järjestetään?

Valitse yksi 

- a. 50/50 julkinen yksityinen
- b. Yksityinen vain jos julkiselta ei löydy maksajaa
- c. Jotain
...
![](images/kuntoutustaho.png)
  </div>
</div>

### Työikäisen ihmisen kuntoutuksen tavoite
...
- Tavoitteena ei ole rappeuma-ja kulumaprosesseista johtuvien oireiden 
hoito tai ehkäisy
...
![](images/lääkinnällinenkuntoutus.png)
![](images/vaativakela.png)

### Lääkkeellisen kuntoutuksen aiheellisuus

- a. Aiheellista kun hoito ollut vuoden riittämätön
- b. Aiheellista kun potilas käyttää yhtä kävelysauvaa
- c. Aiheellista työkyvyn ollessa uhattuna
- d. Aiheellista kun toimintakyky on alentunut sairauden vuoksi vähintään vuoden ja henkilöllä on huomattavia vaikeuksia huolehtia arjen toiminnoista tai itsestään
...
<div class="solution">
 ...
 ![](images/lääkkuntoutus.png)
  </div>
</div>

### Milloin ammatilliselle kuntoutukselle löytyy luultavimmin maksaja?
...
- Yksinkertaistettuna työkyvyttömyyden uhka tarkoittaa, että lääkäri epäilee 
potilaan työkyvyn heikkenevän sairauden tai vamman vuoksi 5 vuoden 
sisällä siinä määrin, että hän saattaa poistua työmarkkinoilta
...
![](images/ammatillinenkuntoutusmaksajat.png)
### Kenen vastuulla on kuntoutussuunnitelman laatiminen?
